...
try{
	String rollNo=request.getParameter("course");
	System.out.println("Hiii");
	Connection con=Project.ConnectionProvider.getCon();
	Statement st=con.createStatement();
	ResultSet rs=st.executeQuery("select * from student inner join result where student.rollNo and student.rollNo='"+rollNo+"");
	if(rs.next()){
%>		
